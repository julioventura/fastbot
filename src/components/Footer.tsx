...
const Footer = () => {
  return (
    ...
    <footer className="relative bg-theme-gradient border-t border-theme-accent/30">
      ...
      <div className="section-container py-8 relative z-10" id="footer-section">

        {/* Layout Grid para posicionar logo à esquerda, redes sociais no centro */}
        {/* Grid de 3 colunas: logo à esquerda, redes sociais centralizadas, espaço à direita */}
        <div className="grid grid-cols-3 items-center w-full">
          ...
          {/* Coluna Direita - Vazia para manter simetria */}
          <div></div>
