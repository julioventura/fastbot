        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0 items-center w-full">
          ...
          <div className="flex justify-center order-1 md:order-2">
            ...
            <div className="flex space-x-4 md:space-x-6">
              ...
              {/* Link para Facebook */}
              <a href="https://www.facebook.com/dentistas.com.br/" className="text-gray-400 hover:text-primary transition-colors duration-300">
              ...
              {/* Link para Instagram */}
              <a href="https://www.instagram.com/dentistascombr/" className="text-gray-400 hover:text-primary transition-colors duration-300">
