  ...
  return (
    ...
    <footer className="relative bg-theme-gradient border-t border-theme-accent/30">
      ...
      <div className="section-container py-12 relative z-10" id="footer-section">
        {/* Seção comentada: Layout alternativo para o conteúdo do rodapé (não utilizado atualmente). */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-400 hover:text-brightblue-500">
              <span className="sr-only">Twitter</span> {/* Texto para acessibilidade */}
            ...
            {/* Link para LinkedIn */}
            <a href="#" className="text-gray-400 hover:text-brightblue-500">
              <span className="sr-only">LinkedIn</span> {/* Texto para acessibilidade */}
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Link para GitHub */}
            <a href="#" className="text-gray-400 hover:text-brightblue-500">
              <span className="sr-only">GitHub</span> {/* Texto para acessibilidade */}
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
