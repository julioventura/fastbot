...
const features = [
  {
    title: 'Agent Browser',
    description: 'Launch agent browsers with a single API call. Our browser tech comes with built-in AI that understands content, extracts data, and helps navigate efficiently.',
    icon: (
      <div className="w-12 h-12 rounded-full bg-brightblue-100 flex items-center justify-center">
        <svg className="w-6 h-6 text-brightblue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Automate login flows, data collection, form submissions, and more. Our solution handles CAPTCHAs, cookies, and browsers automatically.',
    icon: (
      <div className="w-12 h-12 rounded-full bg-brightpurple-100 flex items-center justify-center">
        <svg className="w-6 h-6 text-brightpurple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Our browser understands the content, meaning, and objects on web pages, allowing your AI agents to easily navigate and extract data.',
    icon: (
  ...
  },
  {
    ...
    description: 'Our infrastructure guarantees 99.99% uptime with automatic retry mechanisms and smart routing across millions of IPs worldwide.',
    icon: (
  ...
  },
  {
    ...
    description: 'Scale instantly to handle millions of concurrent sessions with our infinitely scalable browser infrastructure.',
    icon: (
      <div className="w-12 h-12 rounded-full bg-brightpurple-100 flex items-center justify-center">
        <svg className="w-6 h-6 text-brightpurple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Start in minutes with our comprehensive SDKs for Node.js, Python, and more. Intuitive APIs make integration simple and fast.',
    icon: (
      <div className="w-12 h-12 rounded-full bg-teal-100 flex items-center justify-center">
        <svg className="w-6 h-6 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
