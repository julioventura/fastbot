...
const Pricing = () => {
  return (
    <section id="pricing" className="relative py-16 md:py-24 bg-gradient-to-b from-[#0a1629] to-[#0e2d5e]">
      {/* SVG Glow Effect */}
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingPlans.map((plan, index) => (
            <Card key={index} className={`p-8 relative bg-[#0a1629]/50 backdrop-blur-sm ${plan.isPopular ? 'border-2 border-brightblue-500 shadow-xl' : 'border border-[#2a4980]/50 shadow-md'}`}>
              {plan.isPopular && (
